...
if USING_NEW_CONFIG:
    ...
    API_KEYS = {
        ...
        "revise_local_patch": settings.revise_api_key or settings.unified_api_key,
        "stitch": settings.revise_api_key or settings.unified_api_key,
        # 保留旧键兼容
    ...
    MODELS = {
        ...
        "revise_local_patch": settings.revise_model,
        "stitch": settings.revise_model,
        # 保留旧键兼容
    ...
    TEMPERATURES = {
        ...
        "revise_local_patch": settings.revise_temperature,
        "stitch": settings.revise_temperature,
        # 保留旧键兼容
    ...
    API_KEYS = {
        ...
        "revise_local_patch": os.getenv("WRITER_API_KEY_REVISE", ""),
        "stitch": os.getenv("WRITER_API_KEY_REVISE", ""),
    ...
    MODELS = {
        ...
        "revise_local_patch": "ark-code-latest",
        "stitch": "ark-code-latest",
