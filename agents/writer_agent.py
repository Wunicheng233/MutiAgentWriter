...
3. 【**字数硬要求，非常重要**】本章字数**必须严格控制在 {target_word_count} 字左右**，误差不能超过200字。如果大纲描述简洁，请你**主动铺展细节**：场景描写、人物动作、表情、心理活动、环境氛围都需要充分展开，不能因为大纲简洁就只写骨架。仅仅写完大纲列出的情节节点是不够的，必须填充细节才能达到字数要求！
